      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2.5">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-600 font-mono text-base font-bold text-white">
              S
            </div>
          ...
          <p className="mt-2 text-sm text-gray-400">
            Get started with interactive coding screencasts
          </p>
        </div>
        ...
        <div className="card p-8">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-700 bg-gray-800/50 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-gray-800"
          >
